  ...
  <div class="new-list-rank-container">
        ...
        >
          ...
          <div class="new-list-item-text">
            ...
            <div class="new-list-item-observer">
              <span>
                <img :src="require('@/assets/observer.png')" alt="" />
                {{ item.number }}
              </span>
              <span>
                {{ item.type }}
    ...
    <div class="energy-rank">
      ...
      <div class="energy-rank-type">
        ...
        <div class="energy-rank-select-wrapper">
          <div class="energy-rank-select-item">
            请选择品牌
            <img :src="require('@/assets/gray-arrow.png')" alt="" />
          </div>
          <div class="energy-rank-select-item">
            请选择车系
            <img :src="require('@/assets/gray-arrow.png')" alt="" />
      ...
      <div class="energy-load-more">
        查看更多
        <img :src="require('@/assets/blue-arrow.png')" alt="" />
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    async getNewList() {
      try {
        ...
        this.newList = new Array(8).fill(0).map((item) => {
          return {
            title: '全新日产Leaf官图发布 变身为跨界SUV 将于年内海外上市',
            number: 2000,
            type: '导购',
            img: 'https://g.autoimg.cn/@img/www2/chejiahaodfs/g31/M08/6A/54/720x0_c42_autohomecar__ChxoHWfkttKAMqmbABJBcyAubnQ459.png'
          }
        })
      }
    },
    async getRankList() {
      try {
        ...
        this.rankList = new Array(8).fill(0).map((item) => {
          return {
            name: '日产Leaf',
            img: 'https://g.autoimg.cn/@img/www2/chejiahaodfs/g31/M08/6A/54/720x0_c42_autohomecar__ChxoHWfkttKAMqmbABJBcyAubnQ459.png'
          }
